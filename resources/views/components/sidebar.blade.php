<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="apps"
                    ...
                    <li class="sub-submenu dropend">
                        <a href="#invoice" data-bs-toggle="dropdown" aria-expanded="false"
                            class="dropdown-toggle collapsed">Invoice <svg
                    ...
                    <li class="sub-submenu dropend active">
                        <a href="#blog" data-bs-toggle="dropdown" aria-expanded="true"
            ...
            <li class="menu">
                <a href="#elements" data-bs-toggle="dropdown" aria-expanded="false"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="pages"
                    ...
                    <li class="sub-submenu dropend">
                        <a href="#reset" data-bs-toggle="dropdown" aria-expanded="false"
                            class="dropdown-toggle collapsed"> Reset <svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="feather feather-chevron-right">
                    ...
                    <li class="sub-submenu dropend">
                        ...
                        <ul class="dropdown-menu list-unstyled sub-submenu" id="twoStep"
                            data-bs-parent="#pages">
                            <li>
                                <a target="_blank" href="./auth-boxed-2-step-verification.html"> Boxed
                                </a>
                            </li>
                            <li>
                                <a target="_blank" href="./auth-cover-2-step-verification.html"> Cover
                                </a>
                            </li>
                        </ul>
                    </li>
